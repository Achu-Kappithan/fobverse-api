...
export const  MESSAGES ={
    AUTH: {
        ...
        PASSWORD_RESET_LINK_SENT: 'Password reset link sent. Please check your email to update your password.',
        PASSWORD_RESET_SUCCESS: "You've successfully reset your password. Please log in to continue.",
        ...
        UNAUTHORIZED_ADMIN_ACCESS: 'You are not authorized to access the admin panel.',
        ...
        ACCOUNT_LINKED_WITH_GOOGLE: 'This account is linked with Google. Use Google to sign in.',
