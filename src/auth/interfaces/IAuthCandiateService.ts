...
export interface IAuthService {
  ...
  getAllUsers(id:string,pagination:PaginationDto):Promise<PaginatedResponse<UserResponceDto[]>>
  createInternalUser(id:string, dto: InternalUserDto): Promise<UserResponceDto>
  getUserProfile(id:string):Promise<UserResponceDto>
  updateUserProfile(id:string,dto:UpdateInternalUserDto):Promise<UserResponceDto>
